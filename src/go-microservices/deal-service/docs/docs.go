        ...
        "/api/sanatoriums": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Medical profiles (CSV), example: cardiology,pulmonology",
                        "name": "profiles",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Maximum distance to sea in km",
                        "name": "max_distance_to_sea",
                        "in": "query"
                    },
                    {
                        "type": "number",
                    ...
                    {
                        "type": "string",
                        "description": "Sort mode: price_asc,price_desc,distance_asc,distance_desc",
                        "name": "sort",
                        "in": "query"
                    }
                ],
